...
export const UserManagement = () => {
  ...
  console.log("UserManagement - isLoading:", usersLoading);
  ...
  const canManageUser = (targetUser: User) => {
    ...
    if (user.role === "ORG_ADMIN" && targetUser.role !== "SUPER_ADMIN")
      return true;
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        const validatedUsers: BulkUserData[] = jsonData
          .map((row: Record<string, unknown>) => ({
            email: (row.email as string) || "",
            fullName:
              (row.fullName as string) || (row["Full Name"] as string) || "",
            role: (row.role as string) || "EMPLOYEE",
            departmentId:
              (row.departmentId as string) ||
              (row["Department ID"] as string) ||
              "",
  ...
  const filteredUsers = users.filter((userItem) => {
    ...
    const matchesDepartment =
      ...
      userItem.departmentId === selectedDepartment;
  ...
  if (usersError) {
    const isPermissionError =
      ...
      usersError.message?.includes("INSUFFICIENT_PERMISSIONS");
    ...
    return (
      <div className="p-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            {isPermissionError
              ? "You need administrator privileges to access user management. Please contact your system administrator."
          ...
          {canPerformAction("create-user") && (
            <>
              ...
              >
                ...
                {/* <DialogContent className="sm:max-w-[425px] bg-gradient-glass backdrop-blur-glass border-white/20 max-h-[85vh] overflow-y-auto shadow-2xl"> */}
                <DialogContent className="sm:max-w-[425px] max-h-[90vh] overflow-y-auto fixed top-[25%] left-1/2 transform -translate-y-1/2 z-[100] bg-gradient-glass backdrop-blur-glass border-white/20 shadow-2xl">
                  <DialogHeader>
                    <DialogTitle>Create New User</DialogTitle>
                    <DialogDescription>
                      Add a new user to the system with their role and
                  ...
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      >
                        <SelectTrigger className="col-span-3 z-[500] bg-gradient-glass backdrop-blur-glass-sm border-white/20">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-gradient-glass z-[9999] backdrop-blur-glass border-white/20">
              ...
              >
                ...
                {/* <DialogContent className="sm:max-w-[600px] bg-gradient-glass backdrop-blur-glass border-white/20 max-h-[85vh] overflow-y-auto shadow-2xl"> */}
                <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto fixed top-[25%] left-1/2 transform -translate-y-1/2 z-[100] bg-gradient-glass backdrop-blur-glass border-white/20 shadow-2xl">
                  <DialogHeader>
        ...
        <CardContent className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-center justify-end">
              ...
              >
                {filteredUsers.length} users {usersLoading && "(loading...)"}
              </Badge>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="space-y-3">
            {filteredUsers.map((userItem) => (
              <div
                key={userItem.id}
                className="p-4 bg-gradient-glass backdrop-blur-glass-sm border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-300"
              >
                <div className="flex items-center justify-between">
